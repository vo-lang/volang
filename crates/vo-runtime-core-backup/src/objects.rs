...
#[no_mangle]
pub unsafe extern "C" fn vo_string_len(str_ref: GcRef) -> usize {
    string::len(str_ref)
}

#[no_mangle]
pub unsafe extern "C" fn vo_string_index(str_ref: GcRef, idx: usize) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn vo_slice_len(slice_ref: GcRef) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn vo_slice_cap(slice_ref: GcRef) -> usize {
    if slice_ref.is_null() {
        return 0;
    }
    slice::cap(slice_ref)
...
#[no_mangle]
pub unsafe extern "C" fn vo_slice_get(slice_ref: GcRef, idx: usize) -> u64 {
    slice::get(slice_ref, idx)
}

#[no_mangle]
pub unsafe extern "C" fn vo_slice_set(slice_ref: GcRef, idx: usize, val: u64) {
...
#[cfg(feature = "std")]
#[no_mangle]
pub unsafe extern "C" fn vo_map_create(
    gc: *mut Gc,
    key_kind: u8,
    val_kind: u8
) -> GcRef {
...
#[cfg(feature = "std")]
#[no_mangle]
pub unsafe extern "C" fn vo_map_len(map_ref: GcRef) -> usize {
    map::len(map_ref)
}

#[cfg(feature = "std")]
#[no_mangle]
pub unsafe extern "C" fn vo_map_get(map_ref: GcRef, key: u64, out_val: *mut u64) -> bool {
...
#[cfg(feature = "std")]
#[no_mangle]
pub unsafe extern "C" fn vo_map_set(map_ref: GcRef, key: u64, val: u64) {
    map::set(map_ref, key, val)
}

#[cfg(feature = "std")]
#[no_mangle]
pub unsafe extern "C" fn vo_map_delete(map_ref: GcRef, key: u64) {
    map::delete(map_ref, key)
}

#[cfg(feature = "std")]
#[no_mangle]
pub unsafe extern "C" fn vo_map_contains(map_ref: GcRef, key: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn vo_closure_create(
    gc: *mut Gc,
    func_id: u32,
    upvalue_count: usize
) -> GcRef {
...
#[no_mangle]
pub unsafe extern "C" fn vo_closure_func_id(closure: GcRef) -> u32 {
    closure::func_id(closure)
}

#[no_mangle]
pub unsafe extern "C" fn vo_closure_upvalue_count(closure: GcRef) -> usize {
    closure::upvalue_count(closure)
}

#[no_mangle]
pub unsafe extern "C" fn vo_closure_get_upvalue(closure: GcRef, idx: usize) -> u64 {
    closure::get_upvalue(closure, idx)
}

#[no_mangle]
pub unsafe extern "C" fn vo_closure_set_upvalue(closure: GcRef, idx: usize, val: u64) {
    closure::set_upvalue(closure, idx, val)
}

#[no_mangle]
pub unsafe extern "C" fn vo_upval_box_create(gc: *mut Gc) -> GcRef {
...
#[no_mangle]
pub unsafe extern "C" fn vo_upval_box_set(uv: GcRef, value: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn vo_interface_unbox_value_kind(slot0: u64) -> u8 {
    interface::unpack_value_kind(slot0) as u8
}

#[no_mangle]
pub unsafe extern "C" fn vo_interface_unbox_value_type_id(slot0: u64) -> u16 {
    interface::unpack_value_type_id(slot0)
}

#[no_mangle]
pub unsafe extern "C" fn vo_interface_unbox_data(slot1: u64) -> u64 {
    interface::unbox_data(slot1)
}

#[no_mangle]
pub unsafe extern "C" fn vo_interface_is_nil(slot0: u64, slot1: u64) -> bool {
