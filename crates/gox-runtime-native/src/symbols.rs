...
impl RuntimeSymbols {
    ...
    pub fn new() -> Self {
        let symbols = vec![
            ...
            RuntimeSymbol { name: "gox_extern_call", ptr: crate::extern_dispatch::gox_extern_call as *const u8 },
            ...
            RuntimeSymbol { name: "gox_chan_new", ptr: crate::goroutine::gox_chan_new as *const u8 },
