//! Lexer for the GoX programming language.
//!
//! This module provides tokenization of GoX source code, including:
...
impl<'src> Lexer<'src> {
    ...
    pub fn next_token(&mut self) -> Token {
        ...
        if self.pending_semicolon {
            ...
            let span = Span::from_u32(self.pos, self.pos);
...
mod tests {
    ...
    fn lex(source: &str) -> Vec<TokenKind> {
        let lexer = Lexer::new(FileId::DUMMY, source);
