...
use vo_analysis::{ObjKey, TypeKey};
use vo_common::Symbol;
use vo_vm::bytecode::{Constant, IfaceDispatchEntry, Module};
...
impl CodegenContext {
    ...
    pub fn add_struct_type(&mut self, meta: vo_vm::types::TypeMeta) {
        self.module.struct_types.push(meta);
    }

    pub fn add_interface_type(&mut self, meta: vo_vm::types::TypeMeta) {
    ...
    pub fn add_function(&mut self, func_def: vo_vm::bytecode::FunctionDef) -> u32 {
