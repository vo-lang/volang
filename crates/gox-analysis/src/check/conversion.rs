...
//!
//! This module implements explicit type conversion checking.
...
impl Checker {
    ...
    pub fn convertible_to(&mut self, x: &Operand, t: TypeKey) -> bool {
        ...
        // Note: GoX has no complex types, so no complex conversion check
        ...
        // Note: GoX has no UnsafePointer, so no unsafe pointer conversion check

        false
    }

    /// Reports whether t is a slice of bytes or runes.
