...
// Both replacement Web packages own only the transport provider. Keep legacy
// kernels out of their actual Wasm dependency graph, including compiler builds.
...
assert.deepEqual([...uiPackages],['vo-ui-bridge'],'replacement Web package links a legacy UI dependency');

// The compiler is downloaded only for Playground runs. vo-web/pkg remains the
// separate default compatibility build used by the previous Web consumers.
...
assert.equal(code, 0, 'replacement Web package build failed');
