...
actions=(
  ...
  "--wait-text=✓ VM, JIT, Wasm VM, and Native AOT targets discovered"
  "--click=vo.mod"
  ...
  "--click=Wasm VM release"
  "--wait-text=Target changed to Wasm VM release"
  "--click=Run project"
  "--wait-text=Run 1 completed with Wasm VM release"
  ...
  "--click=README.md"
  "--wait-text=The same component tree runs in VM/JIT development, Wasm VM, and Native AOT releases."
