...
if (process.env.VO_BENCH_METRICS === '1') {
  process.stderr.write(`BENCH_METADATA:${JSON.stringify({
    runMs: performance.now() - started,
    memoryStats: execution.memoryStats,
    schedulerStats: execution.schedulerStats,
  })}\n`);
}
