...
| URL                                              | Meaning                       |
|--------------------------------------------------|-------------------------------|
| `https://github.com/vo-lang/MarbleRush`          | GitHub repo, default branch   |
| `https://github.com/vo-lang/MarbleRush/tree/main/sub` | GitHub repo, ref + subdir |
| `/Users/me/code/MarbleRush`                      | Local path (native only)      |
...
```
volang.dev/?proj=https://github.com/vo-lang/MarbleRush
volang.dev/?proj=https://github.com/vo-lang/MarbleRush&mode=dev
```
...
```bash
./d.py studio-native https://github.com/vo-lang/MarbleRush
./d.py studio-native /path/to/project
./d.py studio-native --runner https://github.com/vo-lang/MarbleRush
./d.py studio https://github.com/vo-lang/MarbleRush
```
...
```
volang.dev/?proj=https://github.com/vo-lang/MarbleRush/tree/abc123&mode=runner
```
