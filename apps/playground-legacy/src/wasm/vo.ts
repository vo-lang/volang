...
async function loadWasm(): Promise<any> {
  ...
  try {
    ...
    const { default: init, compileAndRun, compileAndRunWithModules, version, initGuiApp, initGuiAppWithModules, handleGuiEvent } = await import('@vo-apps/playground-legacy/vo_playground.js');
    await init();
