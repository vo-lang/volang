...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::gui::cmd_enqueue_webview_bridge,
            commands::gui::cmd_stage_webview_restart_snapshot,
            commands::gui::cmd_poll_webview_bridge,
            commands::gui::cmd_submit_webview_bridge,
            commands::gui::cmd_take_webview_bridge_input,
            commands::gui::cmd_restart_webview_bridge,
            commands::gui::cmd_restart_webview_bridge_with_snapshots,
            commands::gui::cmd_create_platform_window,
            commands::gui::cmd_close_platform_window,
            commands::gui::cmd_create_platform_view,
            commands::gui::cmd_update_platform_view_metrics,
            commands::gui::cmd_close_platform_view,
            commands::gui::cmd_attach_platform_surface,
            commands::gui::cmd_resolve_platform_surface,
            commands::gui::cmd_register_platform_surface_shortcuts,
            commands::gui::cmd_update_platform_surface_geometry,
            commands::gui::cmd_close_platform_surface,
            commands::gui::cmd_report_platform_surface_outcome,
            commands::gui::cmd_begin_platform_surface_recovery,
            commands::gui::cmd_complete_platform_surface_recovery,
            commands::gui::cmd_route_platform_input,
