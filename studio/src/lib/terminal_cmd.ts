...
// Format an fs.list result for terminal output.
function formatFsListResult(data: unknown): string[] {
...
// Format an fs.stat result.
function formatStatResult(data: unknown): string[] {
...
function formatGitStatus(data: unknown): string[] {
...
function formatGitLog(data: unknown): string[] {
...
function formatGitBranch(data: unknown): string[] {
...
// Format zip.list result.
function formatZipList(data: unknown): string[] {
