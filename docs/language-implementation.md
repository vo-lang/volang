...
| Runtime dynamic assignability | `vo-common-core::dynamic_layout` | Native and Wasm VM runtimes |
...
`wasm` targets. Native AOT requires separate generated-object and linked-image
coverage. Wasm VM regressions establish language results, defer/recover behavior,
GC visibility and browser host integration.
