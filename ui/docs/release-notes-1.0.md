...
The GA contract completes E0-E8, 57 stable required capabilities, five
showcases, and twelve product gates. Release provenance binds the governance
digest and `product-certified` status to the tagged candidate commit.
